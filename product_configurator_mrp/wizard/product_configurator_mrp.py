...
class ProductConfiguratorMrp(models.TransientModel):
    ...
    order_id = fields.Many2one(
        comodel_name="mrp.production", string="Manufacturing Order", required=True
    )
    ...
    def action_config_done(self):
        ...
        try:
            custom_vals = {
                line.attribute_id.id: line.value or line.attachment_ids
            ...
            raise ValidationError(
                _(
                    "Invalid configuration! Please check all "
